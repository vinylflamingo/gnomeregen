...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.gnomeregen.localhost/ --auth https://id.gnomeregen.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.gnomeregen.localhost/ --auth https://id.gnomeregen.localhost/ --allow-write true
}
...
Start-Process https://cm.gnomeregen.localhost/sitecore/
Start-Process https://www.gnomeregen.localhost/
