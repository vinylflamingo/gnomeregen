...
Add-HostsEntry "cm.gnomeregen.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.gnomeregen.localhost"
}
Add-HostsEntry "id.gnomeregen.localhost"
Add-HostsEntry "www.gnomeregen.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.gnomeregen.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.gnomeregen.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.gnomeregen.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.gnomeregen.localhost"
